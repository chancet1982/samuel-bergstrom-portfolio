      ...
      elements: [
        {
          ...
          data: {
            ...
            caption: {
              ...
              title: "pre-study",
              h: 1,
              text: <Paragraph xl>When fitness meets ecommerce</Paragraph>,
            },
            fgImage: {
        ...
        },
        {
          ...
          data: {
            ...
            items: [
              {
                value: "51.2%",
                label: "Prefer online registration",
              },
              {
                value: "44%",
                label: "Interested in group training",
              },
              {
                value: "31.6%",
                label: "Consider a personal tainer",
              },
            ],
          },
        },
